...
<body>
<div class="container">
    <h1>Detalhes do Quarto Single</h1>
    <div class="imagens-container">
        <img class="imagem" src="imagens/varandasingle.jpg" alt="img1">
        <img class="imagem" src="imagens/quartoluxo2.jpg" alt="img2">
        <img class="imagem" src="imagens/banheirosingle.jfif" alt="img3">
    </div>
    <p>Ideal para uma pessoa, com minimalismo somado ao bem estar.</p>
    <br>
