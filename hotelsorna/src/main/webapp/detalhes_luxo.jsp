...
<body>
<div class="container">
    <h1>Detalhes do Quarto Luxo</h1>
    <div class="imagens-container">
        <img class="imagem" src="imagens/varandaluxo.jpg" alt="img1">
        <img class="imagem" src="imagens/quartoluxo2.jpg" alt="img2">
        <img class="imagem" src="imagens/banheiroluxo1.jpg" alt="img3">
    </div>
    <p>Ideal para quem busca conforto e tranquilidade com sofisticação.</p>
        <br>
