...
<body>
<div class="container">
    <h1>Detalhes do Quarto Estudante</h1>
    <div class="imagens-container">
        <img class="imagem" src="imagens/varandaestudante.jpg" alt="img1">
        <img class="imagem" src="imagens/mesaestudante.jpg" alt="img2">
        <img class="imagem" src="imagens/banheiroestudante.jfif" alt="img3">
    </div>
    <p>Ideal para quem precisa se concentrar nos estudos por uma longa estadia, sem nenhuma distração.</p>
    <br>
